...
export interface Database {
  ...
  public: {
    Tables: {
      ...
      daily_metrics: {
        Row: {
          ...
          approved_photos: number | null;
          created_at: string;
          date: string;
          new_photos: number | null;
          registered_users: number | null;
          rejected_photos: number | null;
          reports: number | null;
        };
        Insert: {
          active_users?: number | null;
      ...
      favorites: {
        ...
        Relationships: [
          ...
          },
          {
            ...
            columns: ["photo_id"];
            isOneToOne: false;
            referencedRelation: "public_photos_v";
            referencedColumns: ["id"];
          },
        ];
      };
    ...
    Functions: {
      ...
      st_srid: { Args: { geog: unknown }; Returns: number } | { Args: { geom: unknown }; Returns: number };
      st_subdivide: {
    ...
    Enums: {
      ...
      time_of_day:
        ...
        | "blue_hour"
        | "night";
      user_role: "photographer" | "enthusiast";
    };
    CompositeTypes: {
      geometry_dump: {
        path: number[] | null;
