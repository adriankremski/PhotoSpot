...
describe("FilterPanel", () => {
  ...
  it("should render filter controls", () => {
    render(<FilterPanel filters={mockFilters} onFiltersChange={mockOnFiltersChange} onReset={mockOnReset} />);
  ...
  it("should show active filter count", () => {
    ...
    render(<FilterPanel filters={activeFilters} onFiltersChange={mockOnFiltersChange} onReset={mockOnReset} />);
  ...
  it("should disable controls when loading", () => {
    render(
      <FilterPanel filters={mockFilters} onFiltersChange={mockOnFiltersChange} onReset={mockOnReset} isLoading={true} />
    );
