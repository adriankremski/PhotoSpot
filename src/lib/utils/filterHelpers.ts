...
export function validateFilters(filters: PhotoFilters): PhotoFilters {
  return {
    category: filters.category && isPhotoCategory(filters.category) 
      ? filters.category 
      : null,
    season: filters.season && isSeason(filters.season) 
      ? filters.season 
      : null,
    time_of_day: filters.time_of_day && isTimeOfDay(filters.time_of_day) 
      ? filters.time_of_day 
      : null,
...
export function mergeFilters(
  ...
  return {
    ...
    photographer_only: updates.photographer_only !== undefined 
      ? updates.photographer_only 
      : base.photographer_only,
  };
}
